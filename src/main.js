...
const mDashboardNav = document.querySelector(".modal__dashboard");
const mSettings = document.querySelector(".modal__settings");
...
function listDashboards() {
  mDashboardNav.classList.remove("hidden");
  mDashboardNav.classList.add("block");
}
function listSettings() {
  mSettings.classList.remove("hidden");
  mSettings.classList.add("block");
}
document.addEventListener("mouseover", function (event) {
  const notClanguage = document.querySelector(".modal_language.block");
  if (
    event.target == profile ||
    event.target == allEli[2] ||
    event.target == allEli[5] ||
    event.target == allEli[7]
  ) {
    mLanguageHide.classList.remove("block");
    mLanguageHide.classList.add("hidden");
    mDashboardNav.classList.remove("block");
    mDashboardNav.classList.add("hidden");
    mSettings.classList.remove("block");
